...
"[project]/src/app/api/recursos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!netResponse.ok) {
            ...
            try {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Error backend (.NET): ${netResponse.status}`,
                    detail: errorText
                }, {
                    status: netResponse.status
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d62dbc7._.js.map